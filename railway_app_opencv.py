# Railway OpenCV Egg Detection API
# Uses OpenCV-based detection instead of YOLO to reduce image size
...
app = FastAPI(title="NumberEgg OpenCV API", version="1.0.0", lifespan=lifespan)
...
async def root():
    """Root endpoint"""
    return {"message": "NumberEgg OpenCV API is running", "version": "1.0.0", "model": "OpenCV Edge Detection"}
